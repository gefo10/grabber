...
class CartServiceImplTest {
    ...
    void deleteCartItem_Success() {
        ...
        // and cartId
        doNothing().when(cartItemRepository).deleteCartItemByProductIdAndCartId(
                eq(1L), eq(cart.getCartId()));
    ...
    void clearCart_Success() {
        ...
        Product prod1 = new Product(10L, "Laptop", "img.jpg", "Fast Laptop", 5, 1500.0, 10.0, 1350.0, null);
        Product prod2 = new Product(20L, "Mouse", "img2.jpg", "Wireless Mouse", 15, 50.0, 0.0, 50.0, null);
        ...
        doNothing().when(cartItemRepository).deleteCartItemByProductIdAndCartId(eq(100L), eq(2L));
        doNothing().when(cartItemRepository).deleteCartItemByProductIdAndCartId(eq(200L), eq(2L));
        ...
        verify(cartItemRepository).deleteCartItemByProductIdAndCartId(eq(100L), eq(2L));
        verify(cartItemRepository).deleteCartItemByProductIdAndCartId(eq(200L), eq(2L));
