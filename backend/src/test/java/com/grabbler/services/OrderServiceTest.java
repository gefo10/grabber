...
public class OrderServiceTest {
    ...
    public void testPlaceOrder_Success() {
        ...
        when(orderItemRepository.saveAll(any(List.class))).thenAnswer(invocation -> {
        ...
        when(productService.decreaseProductQuantity(eq(product.getProductId()), eq(cartItem.getQuantity())))
                .thenReturn(true);
