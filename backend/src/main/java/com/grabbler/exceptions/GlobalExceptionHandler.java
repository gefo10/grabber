...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleIllegalArgumentException(
        ...
        ErrorResponse errorResponse = new ErrorResponse(
                ErrorCode.INVALID_REQUEST.getCode(), ex.getMessage(), request.getRequestURI());
    ...
    public ResponseEntity<ErrorResponse> handleHttpMessageNotReadableException(
        ...
        ErrorResponse errorResponse = new ErrorResponse(ErrorCode.INVALID_REQUEST.getCode(), message,
                request.getRequestURI());
    ...
    public ResponseEntity<ErrorResponse> handleUserNotFoundException(
        ...
        ErrorResponse errorResponse = new ErrorResponse(
                ErrorCode.USER_NOT_FOUND.getCode(), ex.getMessage(), request.getRequestURI());
    ...
    public ResponseEntity<ErrorResponse> handleResourceNotFoundException(
        ...
        ErrorResponse errorResponse = new ErrorResponse(
                ErrorCode.RESOURCE_NOT_FOUND.getCode(), ex.getMessage(), request.getRequestURI());
    ...
    public ResponseEntity<ErrorResponse> handleAPIException(
        ...
        ErrorResponse errorResponse = new ErrorResponse(
                ErrorCode.BUSINESS_RULE_VIOLATION.getCode(), ex.getMessage(), request.getRequestURI());
