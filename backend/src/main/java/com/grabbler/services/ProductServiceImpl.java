...
public class ProductServiceImpl implements ProductService {
  ...
  public ProductDTO recoverUpdateProduct(
      ObjectOptimisticLockingFailureException e, Long productId, UpdateProductRequest request) {
  ...
  public ProductDTO recoverPartialUpdateProduct(
      ObjectOptimisticLockingFailureException e, Long productId, PatchProductRequest request) {
  ...
  public boolean recoverDecreaseProductQuantity(
      ObjectOptimisticLockingFailureException e, Long productId, Integer quantity) {
