...
public class UserController {
  ...
  @Operation(
      ...
      description = "Admin can get any user, users can only get themselves")
  ...
  @Operation(
      summary = "Update user",
      description = "Admin can update any user, users can only update themselves")
  @PreAuthorize("hasRole('ADMIN') or #userId == authentication.principal.userId")
  @PutMapping("/{userId}")
  ...
  @Operation(
      summary = "Delete user",
      description = "Admin can delete any user, users can delete their own account")
  @PreAuthorize("hasRole('ADMIN') or #userId == authentication.principal.userId")
  ...
  public ResponseEntity<UserResponse> getAllUsers(
      ...
      @org.springframework.web.bind.annotation.RequestParam(defaultValue = "asc")
          String sortOrder) {
