...
public class CategoryController {
  ...
  public ResponseEntity<CategoryDTO> createCategory(
      @Valid @RequestBody Category category) { // TODO: use
    // CreateCategoryDTO
    // instead of Category
  ...
  public ResponseEntity<CategoryDTO> updateCategory(
      @PathVariable Long categoryId, @Valid @RequestBody Category category) {
  ...
  @Operation(
      ...
      description = "Deletes a product category by its ID. Admin access required.",
      tags = {"Category Management"})
  @PreAuthorize("hasRole('ADMIN')")
